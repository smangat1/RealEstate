...
const profileSchema = z.object({
  ...
  advisorFinancialMode: z.enum(["available_on_request", "provided", "template"]).optional(),
  advisorIncomeMultiple: z.string().trim().max(40).nullable().optional(),
  advisorCreditScore: z.string().trim().max(40).nullable().optional(),
  advisorSetupCompletedAt: z.string().datetime().nullable().optional(),
  advisorSetupVersion: z.number().int().min(1).max(20).optional(),
