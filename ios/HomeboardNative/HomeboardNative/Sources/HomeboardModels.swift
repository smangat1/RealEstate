...
struct AdvisorFact: Identifiable, Hashable, Codable {
  var id: String { key }
  var key: String
  var label: String
  var value: String
...
struct AdvisorSourceLink: Identifiable, Hashable, Codable {
  var id: String { url }
  var label: String
  var url: String
  var provider: String?
...
struct AdvisorActionCommand: Hashable, Codable {
  var type: String
  var label: String
...
struct AdvisorAction: Identifiable, Hashable, Codable {
  ...
  var facts: [AdvisorFact]
  var sourceLinks: [AdvisorSourceLink]
  var primaryAction: AdvisorActionCommand
  var secondaryActions: [AdvisorActionCommand]
  var engine: String
  var createdAt: String
  var updatedAt: String
...
struct ListingChangeEntry: Identifiable, Hashable, Codable {
  var id: String
  var boardListingId: String
  var kind: String
  var field: String
  var beforeValue: CodableValue?
  var afterValue: CodableValue?
  var explanation: String
  var whyItMatters: String
  var sourceUrl: String?
...
enum CodableValue: Hashable, Codable {
  case string(String)
  case number(Double)
  case bool(Bool)
  ...
  init(from decoder: Decoder) throws {
    ...
    else if let value = try? container.decode([String: CodableValue].self) { self = .object(value) }
    else { self = .array(try container.decode([CodableValue].self)) }
  }
...
struct ApplicationChecklistEntry: Identifiable, Hashable, Codable {
  var id: String
  var boardListingId: String
  var key: String
  var label: String
...
struct AgentReplyFacts: Hashable, Codable {
...
struct TourNoteSummary: Hashable, Codable {
  var pros: [String]
  var cons: [String]
  var concerns: [String]
...
struct ListingInquiry: Identifiable, Hashable, Codable {
  var id: String
  var boardListingId: String
  var userId: String
  var userName: String?
  ...
  var replyFacts: AgentReplyFacts?
  var createdAt: String
  var updatedAt: String
}
...
struct ScoutSubscription: Hashable, Codable {
  var id: String
  var boardId: String
  var status: String          // "pending_split" | "active" | "paused" | "expired"
  var tier: String
  var amountCents: Int
  var currency: String
  ...
  var remainingCents: Int {
    max(0, targetCents - fundedCents)
  }
  func contribution(for userID: String?) -> ScoutContribution? {
    guard let userID, !userID.isEmpty else { return nil }
    return contributions.first { $0.userId == userID }
  }
...
struct MobileBoard: Hashable, Codable {
  ...
  var advisorActions: [AdvisorAction] = []
  // Advisor board subscription
